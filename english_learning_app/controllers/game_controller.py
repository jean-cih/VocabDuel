...
# Нужно сделать статистику использования приложения:
# Сколько слов в день было повторено
# Сколько дней использовалось приложение
# Сколько дней подряд испльзовалось приложение
# График того сколько раз было повторено слово
# График того сколько раз был повторен весь словарь
